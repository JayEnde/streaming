let totalMessages = 0, maxCount = 0, fontColorName = "user", removeSelector, addition, fontColorNameCustom, channelName,
    provider;
...
window.addEventListener('onEventReceived', function (obj) {
    ...
    if (hiddenUsers.indexOf(data.nick) !== -1) return;
...
window.addEventListener('onWidgetLoad', function (obj) {
    ...
    maxCount = fieldData.maxCount;
    fontColorName = fieldData.fontColorName;
    fontColorNameCustom = fieldData.fontColorNameCustom;
    ...
    if (fieldData.alignMessages === "flex-start") {
        addition = "prepend";
        removeSelector = ".message-row:nth-child(n+" + (maxCount + 1) + ")"
    } else {
        addition = "append";
        removeSelector = ".message-row:nth-last-child(n+" + (maxCount + 1) + ")"
    }

    hiddenUsers = fieldData.hiddenUsers.toLowerCase().replace(" ", "").split(",");
});
